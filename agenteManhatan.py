...
def lista_callesM(copia_grafo, ruta):
...
def distancia_totalM(ruta, posiciones):
    distancia_total = 0.0
...
def algoritmo_distancia_manhattan(nodo_inicial, nodo_objetivo, copia_grafo):
    ...
    while cola_prioridad:
        ...
        if nodo_actual not in visitados:
            ...
            for vecino in vecinos:
                ...
                costo_total = nuevo_costo + costo_heuristico_manhattan(vecino, nodo_objetivo, copia_grafo)
                heapq.heappush(cola_prioridad, (costo_total, vecino, nuevo_camino))

    return None

def costo_heuristico_manhattan(u, v, copia_grafo):
